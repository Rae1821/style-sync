...
// Products for Shape & Style Combos

export const classicPearTerms = [
  "A-line skirts",
  "tailored trousers",
  "wide-leg pants",
  "wrap dresses",
...
export const classicAppleTerms = [
  "empire waist dresses",
  "A-line dresses",
  "straight-leg trousers",
  "relaxed-fit blouses",
  "V-neck tops",
  "tailored jackets (worn open)",
  "delicate necklaces",
  "structured handbags",
];

export const classicHourglassTerms = [
...
export const classicRectangleTerms = [
  "straight-leg trousers",
  "tailored blazers",
  "sheath dresses",
  "column dresses",
...
export const classicInvertedTriangleTerms = [
  "wide-leg pants",
  "A-line skirts",
  "full skirts",
  "peplum tops",
  "scoop neck tops",
  "soft shoulder blouses",
  "delicate earrings",

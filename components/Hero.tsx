...
const Hero = () => {
  ...
  return (
    <section className="bg-[url(/images/hero.png)] md:bg-[url(/images/hero.jpg)] bg-fixed md:bg-center bg-no-repeat bg-contain bg-right-bottom md:bg-cover mx-auto flex w-full pt-24 md:items-center h-svh md:h-[800px]">

...
const Hero = () => {
  ...
  return (
    <section className="bg-[url(/images/hero.png)] md:bg-[url(/images/hero.jpg)] bg-fixed bg-center bg-no-repeat bg-cover lg:bg-cover mx-auto flex w-full pt-24 md:items-center h-svh md:h-[800px]">

...
const Hero = () => {
  ...
  return (
    <section className="bg-[url(/images/hero.jpg)] bg-fixed bg-right-top bg-no-repeat bg-contain lg:bg-cover mx-auto flex w-full pt-24 md:items-center h-lvh lg:h-[800px]">
